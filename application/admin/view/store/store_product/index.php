...
<!--                        <p>{{d.mer_name}}</p>-->
                    ...
                    <script type="text/html" id="act">
                        ...
                        <button type="button" class="layui-btn layui-btn-xs btn-success" onclick="$eb.createModalFrame('{{d.store_name}}-属性','{:Url('edit_content')}?id={{d.id}}')">
                            编辑内容
                        </button>
                        ...
                        <button type="button" class="layui-btn layui-btn-xs layui-btn-danger" lay-event='delstor'>
                            删除
                        </button>
                    </script>
                </div>
    ...
    layList.tableList('List',"{:Url('product_ist',['type'=>$type])}",function (){
        ...
        switch (parseInt(type)){
            case 1:case 3:case 4:case 5:
                join=[
                    {field: 'id', title: 'ID', sort: true,event:'id',width:'6%',templet:'#_id'},
