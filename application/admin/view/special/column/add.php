                    ...
                    <div class="layui-tab-content">
                        ...
                        <div class="layui-tab-item layui-show">
                            <div class="layui-form-item m-t-5">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="title" v-model="formData.title" autocomplete="off"
                                            placeholder="请输入专栏名称" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item m-t-5">
                            ...
                            <div class="layui-form-item m-t-5">
                                ...
                                <div class="layui-input-block">
                            <textarea placeholder="请输入专栏简介" v-model="formData.abstract"
                            ...
                            <div class="layui-form-item m-t-5">
                                ...
                                <div class="layui-input-block">
                            <textarea placeholder="请输入专栏短语" v-model="formData.phrase"
                                        class="layui-textarea"></textarea>
                                </div>
                            </div>
                            <div class="layui-form-item m-t-5">
                                ...
                                <div class="layui-form-item" v-show="formData.member_pay_type == 1">
                                    ...
                                    <div class="layui-input-block">
                                        <input style="width: 20%" type="number" name="member_money" lay-verify="number"
                                                v-model="formData.member_money" autocomplete="off" class="layui-input"
                                                min="0">
                                    </div>
                                </div>
                            </div>
                    ...
                    show_source_list: function () {
                        ...
                        table.render({
                            ...
                            , cols: [[
                                ...
                                {field: 'image', title: '封面', align: 'center', templet: '<div><img src="{{ d.image }}"></div>'},
                                {
