            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="store_name">
                        <h4>{{d.integral_name}}</h4>
                        <p>所需积分:<font color="red">{{d.integral}}</font> </p>
                        {{# if(d.cate_name!=''){ }}
                        <p>分类:{{d.cate_name}}</p>
                        {{# } }}
                        <p>访客量:{{d.visitor}}</p>
                    ...
                    <script type="text/html" id="act">
                        <button type="button" class="layui-btn layui-btn-xs btn-success" onclick="$eb.createModalFrame('{{d.integral_name}}-属性','{:Url('attr')}?id={{d.id}}',{h:700,w:800})">
                            属性
                        </button>
                        <button type="button" class="layui-btn layui-btn-xs layui-btn-normal" onclick="$eb.createModalFrame('{{d.integral_name}}-编辑','{:Url('edit')}?id={{d.id}}')">
                            编辑
                        </button>
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame(this.innerText,'{:Url('store.storeProductReply/index')}?product_id={{d.id}}')">
        ...
        switch (parseInt(type)){
            case 1:case 3:case 4:case 5:
                join=[
                    ...
                    {field: 'integral_name', title: '产品名称',templet:'#store_name'},
