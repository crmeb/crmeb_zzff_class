            ...
            <div class="ibox-content">
                <div class="table-responsive">
                    ...
                    <script type="text/html" id="nickname">
                        <a href="javascript:;" onclick="$eb.createModalFrame('用户资料','{:Url('user_data')}?uid='+{{d.uid}},{w:1000})" style="color:#0079FE">{{d.nickname ? d.nickname :'暂无昵称'}}</a>
                    </script>
                    ...
                    <script type="text/html" id="member">
                        <a href="javascript:;" onclick="$eb.createModalFrame('会员记录','{:Url('member_record')}?uid='+{{d.uid}},{w:1000})" class="layui-btn layui-btn-xs">会员记录</a>
                    </script>
