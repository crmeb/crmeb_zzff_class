                        ...
                        <div class="layui-tab-item layui-show">
                            <div class="layui-form-item m-t-5">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="title" v-model="formData.title" autocomplete="off" placeholder="请输入专栏名称" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item m-t-5">
                            ...
                            <div class="layui-form-item m-t-5">
                                <label class="layui-form-label">专栏短语</label>
                                <div class="layui-input-block">
                                   <textarea placeholder="请输入专栏短语" v-model="formData.phrase" class="layui-textarea"></textarea>
                                </div>
                            </div>
                            <div class="layui-form-item m-t-5">
                                <label class="layui-form-label">专栏排序</label>
                                <div class="layui-input-block">
                            ...
                            <div class="layui-form-item m-t-5">
                                <div class="layui-inline">
                                    <label class="layui-form-label" style="margin-right: 28px">专栏标签</label>
                            ...
                            <div class="layui-form-item m-t-5">
                                <label class="layui-form-label">专栏banner</label>
                                <div class="layui-input-block">
                                    <div class="upload-image-box" v-if="formData.banner.length" v-for="(item,index) in formData.banner" @mouseenter="enter(item)" @mouseleave="leave(item)">
                                        ...
                                        <div class="mask" v-show="item.is_show" style="display: block">
                                            <p>
                                                <i class="fa fa-eye" @click="look(item)"></i>
            ...
            new Vue({
                ...
                methods: {
                    ...
                    save: function () {
                        ...
                        if (Object.keys(that.formData.check_source_sure).length == 0) return layList.msg('请选择专题');
                        if (!that.formData.title) return layList.msg('请输入专栏标题');
                        if (!that.formData.abstract) return layList.msg('请输入专栏简介');
                        if (!that.formData.phrase) return layList.msg('请输入专栏短语');
                    ...
                    show_source_list: function () {
                        ...
                        table.render({
                            elem: '#showSourceList'
                            , cols: [[
                                {field: 'id', title: '编号', sort: true, align: 'center', event: 'id'},
                                {field: 'title', title: '素材标题', align: 'center', edit: 'title'},
                                {field: 'image', title: '封面', align: 'center', templet: '<div><img style="width: 80px;height: 40px;" src="{{ d.image }}"></div>'},
                                {
